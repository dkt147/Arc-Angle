...
CREATE TABLE `orders` (
  ...
  `cards` text NOT NULL,
  `creator_type` enum('Creator','Dreamer','Athlete','Visionary','Rebel','Artist','Musician','Writer','Filmmaker','Photographer','Designer','Coder','Engineer','Scientist','Gamer','Streamer','Entrepreneur','Founder','Leader','Activist','Healer','Mentor','Teacher','Student','Explorer','Storyteller','Performer','Dancer','Producer','DJ','Skater','Runner','Hooper','Footballer','Chef','Stylist','Model','Community Builder','Parent','Faith','Other') NOT NULL,
...
ALTER TABLE `transactions`
  ...
  ADD KEY `idx_transactions_stripe_payment_intent_id` (`stripe_payment_intent_id`),
